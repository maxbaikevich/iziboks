    ...
    <footer className="footer">
      <div className="wrapper">
        ...
        <ul className="footer-heading-list footer-heading-list--mod">
          <li className="footer-heading-item">
        ...
        <ul className="footer-heading-list">
          <li className="footer-heading-item footer-heading-item--first">
            <p className="footer-heading-text footer-heading-text--mod">
              Бизнес
            </p>
          </li>
          <li className="footer-heading-item footer-heading-item--mod">
            <p className="footer-heading-text footer-heading-text--mod">
              Еда и напитки
            </p>
          </li>
